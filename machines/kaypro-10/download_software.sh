#!/bin/bash
# Downloads CP/M software into hd0/0/ (A: under the default HD boot mode):
# Microsoft tools from deramp.com and CBASIC 2 from retroarchive.org. These
# files are copyrighted (Microsoft / Digital Research) but circulate freely
# in the retrocomputing community.
set -e
BASE="https://deramp.com/downloads/microsoft/CPM%20Software"
DEST="$(cd "$(dirname "$0")/hd0/0" && pwd)"
